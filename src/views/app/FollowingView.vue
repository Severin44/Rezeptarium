<template>
  <div class="view active">
    <div class="page-hero">
      ...
      <h1 class="hero-title">👥 <em>Following</em></h1>
    ...
    <div v-if="loaded && !recipes.length" class="empty-state">
      <p class="empty-title">Du folgst noch niemandem</p>
      <p class="empty-sub">Entdecke neue Köche und folge ihnen, um ihren Feed hier zu sehen.</p>
    ...
    <template v-else>
      <div class="toolbar">
        <div class="search-box">
          ...
          <input type="text" v-model="search" placeholder="Following-Feed durchsuchen…">
        </div>
...
import { getFollowingFeed, getLikesForRecipeIds, getRatingsForRecipeIds, likeRecipe, unlikeRecipe } from '../../lib/supabase'
...
async function load() {
  ...
  recipes.value = await getFollowingFeed(authStore.userId)
